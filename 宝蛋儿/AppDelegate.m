...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[UINavigationBar appearance] setBarTintColor:[UIColor colorWithRed:30.0/255 green:31.0/255 blue:51.0/255 alpha:1]];
    return YES;
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "q.___" in the application's documents directory.
